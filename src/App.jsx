...
const firebaseConfig = {
  apiKey: "AIzaSyCIThT9HC0J3AdXDxmwN0Gb2iiV49wOKnY",
  authDomain: "tasks-work-6bc3c.firebaseapp.com",
  databaseURL: "https://tasks-work-6bc3c-default-rtdb.asia-southeast1.firebasedatabase.app",
  projectId: "tasks-work-6bc3c",
  storageBucket: "tasks-work-6bc3c.firebasestorage.app",
  messagingSenderId: "1056042686196",
  appId: "1:1056042686196:web:236eb067c26fd31b2070a1",
...
function ListCard({ list, tasks, onAddTask, onUpdateTask, onDeleteTask, onCompleteTask, onRank, onPriority, onDeleteList, onRenameList, onSortChange, onTaskDragStart, onTaskDragEnd, onTaskDragOver, onTaskDrop, onListDragStart, onListDragEnd, onListDragOver, onListDrop, isListDragging, draggingTaskId }) {
  ...
  return (
    <div onDragOver={(e) => { e.preventDefault(); onListDragOver(list.id); }} onDrop={(e) => { e.preventDefault(); onListDrop(list.id); }}
      style={{ width: 400, minWidth: 300, flexShrink: 0, background: "white", borderRadius: 8, border: `2px solid ${isListDragging ? "#1a73e8" : "#e0e0e0"}`, boxShadow: "0 1px 3px rgba(0,0,0,0.07)", display: "flex", flexDirection: "column", maxHeight: "calc(100vh - 80px)" }}>
      <div draggable
